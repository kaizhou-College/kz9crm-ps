...
<input type="hidden" name="url" value="serviceDimList-feedback">
...
<table class="data_list_table">
	...
	<s:iterator value="serviceByPage" var="list">
		...
		<td class="list_data_op">
			...
			<img onmousedown="serviceFeedbacklList('${list.svrId}')"  title="处理" src="${basePath}/html/images/bt_feedback.gif" class="op_button" />  
...
<script type="text/javascript">
	...
	function serviceFeedbacklList(id){
		location.href="service_serviceFeedbacklList?service.svrId="+id;
	}
