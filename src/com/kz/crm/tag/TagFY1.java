...
public class TagFY1 extends SimpleTagSupport{
	...
	JspWriter out=getJspContext().getOut();
		...
		if(pageIndex!=1){
			out.println("<a href='"+pageUrl+"?byPage.pageIndex=1'>第一页</a>");
			out.println("<a href='"+pageUrl+"?byPage.pageIndex="+(pageIndex-1)+"'>上一页</a>");
		}else{
			out.println("<a href='#'>第一页</a>");
			out.println("<a href='#'>上一页</a>");
		}
		if(pageIndex!=pageMax){
			out.println("<a href='"+pageUrl+"?byPage.pageIndex="+(pageIndex+1)+"'>下一页</a>");
			out.println("<a href='"+pageUrl+"?byPage.pageIndex="+pageMax+"'>最后一页</a>");
		}else {
